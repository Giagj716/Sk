...
API_TOKEN ='7309428791:AAHApAzdu5lUONJHOXP5nSUU0L0sc166RsE'
...
async def user_info(message: Message):
    ...
    if user_data:
        ...
        approval_expiry_str = "𝙊𝙥𝙥𝙨 𝙉𝙤𝙩 𝙖𝙥𝙥𝙧𝙤𝙫𝙚𝙙 𝘾𝙤𝙣𝙩𝙖𝙘𝙩 @GaneshPatel09"
...
async def bgmi_attack(message: Message):
    ...
    args = message.text.split()[1:]
    if len(args) < 4:
        await message.answer(" 🙀𝙐𝙨𝙖𝙜𝙚: /𝙗𝙜𝙢𝙞 <𝙞𝙥> <𝙥𝙤𝙧𝙩> <𝙩𝙞𝙢𝙚_𝙨𝙚𝙘𝙤𝙣𝙙𝙨> <𝙩𝙝𝙧𝙚𝙖𝙙𝙨> \n\n 👉𝙀𝙭𝙖𝙢𝙥𝙡𝙚  /𝙗𝙜𝙢𝙞 20.235.94.237 17870 180 180")
        return
